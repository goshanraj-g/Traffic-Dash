window.addEventListener("load", () => {
  ...
  function createTrafficNPCs() {
    ...
    function createNPCCar() {
      ...
      console.log("Using car model:", carModel);
      ...
      const initialX =
        Math.random() * (roadRect.width - 150) +
        (roadRect.left - gameContainer.getBoundingClientRect().left);
      const initialY = -600 - Math.random() * 2000;
      ...
      console.log("NPC Car created at:", initialX, initialY);
